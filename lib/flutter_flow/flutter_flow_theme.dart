...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF8D9392);
  late Color secondary = const Color(0xFF6C757D);
  late Color tertiary = const Color(0xFF17A2B8);
  late Color alternate = const Color(0xFF343A40);
  ...
  late Color accent1 = const Color(0xFF8D9392);
  late Color accent2 = const Color(0xFFFF8D97);
  late Color accent3 = const Color(0xFFF3E867);
  late Color accent4 = const Color(0x03333333);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF45484C);
  late Color secondary = const Color(0xFF495057);
  late Color tertiary = const Color(0xFF117A8B);
  late Color alternate = const Color(0xFF23272A);
  late Color primaryText = const Color(0xFFF8F9FA);
  late Color secondaryText = const Color(0xFF495057);
  late Color primaryBackground = const Color(0xFF343A40);
  late Color secondaryBackground = const Color(0xFF343A40);
  late Color accent1 = const Color(0xFF45484C);
  late Color accent2 = const Color(0xFFB32A3E);
  late Color accent3 = const Color(0xFFE0A800);
  late Color accent4 = const Color(0x00033333);
  late Color success = const Color(0xFF1E7E34);
  late Color warning = const Color(0xFFE0A800);
  late Color error = const Color(0xFFB32A3E);
